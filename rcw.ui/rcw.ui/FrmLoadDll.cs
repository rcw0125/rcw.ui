        ...
        private void btnSelectDll_Click(object sender, EventArgs e)
        {
            if (this.dlgOpenFile.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    //ProxyObject obj = (ProxyObject)ad.CreateInstanceFromAndUnwrap(@"RV.UI.dll", "RV.UI.ProxyObject");
                    ...
                    int i_order = menuMag.GetModuleMaxOrder(strModuleID);
                    foreach (System.Type type in obj.assembly.GetTypes())
                    {
                        if (type.BaseType != null)
                        {
                            if (type.BaseType.FullName == fullName)
                            {
                                ...
                                var objName = obj.Invoke(type.FullName, "GetDisplayName");
